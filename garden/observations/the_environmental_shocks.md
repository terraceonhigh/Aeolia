...
Elinor Ostrom's 1990 work on governing the commons documented the conditions under which communities have successfully maintained shared resources: clear boundaries, rules matched to local conditions, collective-choice arrangements, monitoring, graduated sanctions, conflict resolution mechanisms. An Ostrom commons governance correction is now implemented in SimEngine.js (2026-04-09): polities with outward civic culture (high IO position) and inclusive institutions (low extractiveness) develop commons governance capacity that reduces their effective fishery depletion rate by up to 38.5%. The formula — `commonsGov = clamp((ioPos × 0.5 + inclus × 0.5 + 0.5) × 0.5, 0, 0.70)` — treats outward culture and inclusive institutions as proxies for the governance conditions Ostrom identified, rather than modeling them individually. This is a defensible simplification: Ostrom's conditions are correlated with civic culture and inclusive institutions in the historical record, even if they are not identical.
