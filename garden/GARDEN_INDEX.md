...
*A navigable index of Clio's working documents — observations on simulation mechanics and primary source fragments. Cross-referenced to `docs/ACADEMIC_GROUNDING.md` where applicable.*
...
| File | Subject | ACADEMIC_GROUNDING § | Academic Sources |
|------|---------|----------------------|-----------------|
...
| `the_two_paths.md` | Military-administrative vs. legal-institutional expansion; four-phase Lattice integration; standard-setting lock-in vs. extractiveness; engine modeling gap | §9, §12, §25 | Greif (1993), Acemoglu-Robinson (2001), North (1990) |

**Structural Analysis**

| File | Subject |
|------|---------|
| `seven_structural_ironies.md` | Seven recurring simulation ironies — cosmopolitan neutrality, piety danger, deterrence as cage |
| `grateful_to_be_neutral.md` | Why the intermediate belt polities prefer genuine neutrality; the commercial value of non-alignment |
| `the_wall_that_isnt_there.md` | Axelrod cultural freeze as structured indifference, not hostility; geography of non-contact |

---

## Fragments (Primary Sources)

*In-universe documents with fictional institutional voices. Ordered by in-world date.*
...
- Garden fragments are primary source documents in fictional institutional voices. They show the simulation's world as it would be experienced by its participants, not analyzed from outside.
- The `docs/ACADEMIC_GROUNDING.md` file has `→ Garden:` cross-references in most sections. Use it as an alternate entry point for navigation by academic framework rather than by mechanic.
